...
<body class="show-spinner">
  <div class="landing-page">
    <div class="mobile-menu ">
      ...
      <ul class="navbar-nav">
        <li class="nav-item"><a href="/" class="scrollTo">INICIO</a></li>
    ...
    <div class="main-container ">
      <nav class="landing-page-nav menu_politicas">
        <div class="container d-flex align-items-center justify-content-between">
          <a class="navbar-logo pull-left  logo_index" href="/">
      ...
      <div class="content-container" style="margin-top: 140px">
                    ...
                    <p class="col-md-12 politicas-p">
                      ...
                      <ul class="tabs">
                        ...
                        <li class="desc-tab">HGV deja expresa constancia de que la información recibida de los usuarios es
                          ...
                          responsabilidad por las consecuencias que de lo anterior se deriven. La aceptación de esta condición se da por
                        ...
                        <li class="desc-tab">La reproducción parcial o total de la documentación publicada en la página web de la Empresa, está regulada
                          integralmente por las normas que sobre derechos de autor rigen en nuestro país. Está prohibida la
                        reproducción con fines económicos o de comercialización. </li>
                      </ul>
                    </p>

                    <h2 class="title-p">TERMINOS Y CONDICIONES GENERALES DE USO DEL APLICATIVO MÓVIL.
                    CONDICIONES LEGALES Y SU ACEPTACIÓN</h2>
                    <p class="col-md-12 politicas-p">
                      ...
                      Condiciones Generales (en adelante, las "Condiciones Particulares"). Con anterioridad a
                      ...
                      aceptadas y el orden público. El Cliente se obliga a abstenerse de utilizar el Portal y los
                      Servicios con fines o efectos ilícitos, contrarios a lo establecido en estas Condiciones
                      Generales, lesivos de los derechos e intereses de terceros, o que de cualquier forma
                      puedan dañar o impedir la normal utilización o disfrute del Portal. 3.3 Medios para la
                      obtención de Contenidos: El Cliente deberá abstenerse de obtener e incluso de intentar
                      obtener informaciones, mensajes, gráficos, dibujos, archivos de sonido y/o imagen,
                      fotografías, grabaciones, software y, en general, cualquier clase de material accesible a
                      través del Portal o de los Servicios (en adelante, los "Contenidos") empleando para ello
                      medios o procedimientos distintos de los que, según los casos, se hayan puesto a su
                      disposición a este efecto o se hayan indicado a este efecto en la página web donde se
                      encuentren los Contenidos o, en general, de los que se empleen habitualmente en
                      Internet a este efecto siempre que no entrañen un riesgo de daño o inutilización del Portal,
                      de los Servicios y/o de los Contenidos. 3.4 Uso correcto de los Contenidos: El Cliente /
                      Usuario se obliga a usar los Contenidos de forma diligente, correcta y lícita y, en particular,
                      se compromete a abstenerse de: (a)Utilizar los Contenidos de forma, con fines o efectos
                      contrarios a la ley, a la moral y a las buenas costumbres generalmente aceptadas o al
                      orden público; (b) reproducir o copiar, distribuir, permitir el acceso del público a través de
                      ...
                      obtenida a través del Portal o de los Servicios para remitir publicidad, comunicaciones con
                      fines de venta directa o con cualquier otra clase de finalidad comercial, mensajes no
                      solicitados dirigidos a una pluralidad de personas con independencia de su finalidad, así
                      como a abstenerse de comercializar o divulgar de cualquier modo dicha información. 3.5
                      Introducción de hiperenlaces que permitan el acceso a las páginas web del Portal y a los
                      Servicios: Los Clientes / Usuarios y, en general, aquellas personas que se propongan
                      establecer un hiperenlace entre su página web y el Portal (en adelante, el "Hiperenlace"
                      definido como establecer un vinculo en una página web para que el portal aparezca como
                      un servicio de esa página web) deberán cumplir las condiciones siguientes:(a) el
                      Hiperenlace únicamente permitirá el acceso a las páginas web del Portal, pero no podrá
                      reproducirlas de ninguna forma; (b) no se establecerán hiperenlaces con las páginas web
                      del Portal distintas de la home-page o página primera del Portal o de los Servicios; (c) no
                      ...
                      condiciones pueden variar sin previo aviso. 5. PUBLICIDAD E INFORMACIÓN
