			...
			<div class="panel-group col-md-10">
				<div class="panel panel-info">
					<div class="panel-heading">
                		<h3 class="p-b-5 text-primary" style="text-align:center;"><span class="semi-bold">Borrar</span> Mascotas</h3>
                		</br>
                		<p class="text-info">Aquí podras eliminar del sistema todas las mascotas que tienes registradas. </p>
            		</div>
