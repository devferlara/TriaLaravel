            ...
            <div class="panel panel-transparent">
                <div class="panel-heading">
                    <div class="col-md-2 pull-right">
                        {!!link_to_route('usuario.descuentos.clubmotor.index', $title = 'Volver a Bonos Motor', $parameters = null, $attributes = ['class'=>'btn btn-primary'])!!}
                    </div>
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-10 well well-sm" style="background:orange;">
                            <div class="col-md-4" >
                                <h5><i class="fa fa-calendar" style="font-size:20px;"></i> {{$publivehiculos->fecha}}
                                    </br>Categoria: {{$publivehiculos->categoria}}
                                    </br>Tienda o Responsable: {{$publivehiculos->emisor}}
                                </h5>
                            </div>
                            <div class="col-md-6" >
                                <h3 style="font-weight:bold; text-align:center; margin-top:20px;">{{$publivehiculos->titulo}}</h3>
                            </div>
                        </div>
                        <div class="col-md-1"></div>
                    <div class="col-md-12">
                        <div class="col-md-1"></div>
                        <div id="" class="col-md-10"><img class="img-responsive" style="margin:0 auto;" alt="Banner Bono" src="{{ asset('uploads/publicidad/vehiculos/'.$publivehiculos->img_banner) }}"/></div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-1"></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-10 well well-lg" style="background:grey;">
                            ...
                            <h6 class="datos"><a class="btn btn-success" target="_blank" href="{{$publivehiculos->link}}">Mayor Información Pulsa Aquí</a></h6>
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                </div>
