            ...
            <div class="social " data-pages="social">
                ...
                <div class="jumbotron" data-pages="parallax" data-social="cover">
                    <div class="cover-photo">
                        <img alt="Cover photo" src="{{ asset('uploads/banners/bannerclubmotor.png') }}" />
                    </div>
                    <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                        <div class="inner">
                            <div class="pull-bottom bottom-left m-b-40">
                                <h3 class="text-white no-margin">Bienvenido</h3>
                                <h1 class="text-white no-margin"><span class="semi-bold">Bonos-Club Motor</span></h1>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="day" data-social="day">
                            ...
                            @foreach($publicidades as $publimotor)
                                ...
                                <div class="card share  col1" data-social="item">
                                    <div class="circle" data-toggle="tooltip" title="Bono Motor" data-container="body">
                                    </div>
                                    ...
                                    @else
                                        <img src="{{ asset('uploads/publicidad/vehiculos/'.$publimotor->img_banner) }}" style="width:250px; height:250px;"/>
                                    @endif
                                        {!!link_to_route('usuario.descuentos.clubmotor.show', $title = 'Ver Bono', $parameters = $publimotor->id, $attributes = ['class'=>'btn btn-tag btn-tag-light btn-tag-rounded anuncio-btn'])!!}
                                    </div>
                                </div>
                            @endforeach
                            <!-- END ITEM -->
