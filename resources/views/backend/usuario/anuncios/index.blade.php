            ...
            <div class="social " data-pages="social">
                ...
                <div class="jumbotron" data-pages="parallax" data-social="cover">
                    <div class="cover-photo">
                        <img alt="Cover photo" src="{{ asset('uploads/banners/banneranuncios.png') }}" />
                    </div>
                    <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                        <div class="inner">
                            <div class="pull-bottom bottom-left m-b-40">
                                <h5 class="text-white no-margin">Conjunto Residencial: </h5>
                                <h1 class="text-white no-margin"><span class="semi-bold">NOTICIAS</span></h1>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="day" data-social="day">
                            ...
                            @foreach($anuncios as $anuncio)
                                ...
                                <div class="card share  col1" data-social="item">
                                    ...
                                    @else
                                        <img src="{{ asset('uploads/anuncios/'.$anuncio->img_banner) }}" style="width:250px; height:250px;"/>
                                    @endif
                                        {!!link_to_route('usuario.noticias.show', $title = 'Ver Noticia', $parameters = $anuncio->id, $attributes = ['class'=>'btn btn-tag btn-tag-light btn-tag-rounded anuncio-btn'])!!}
                                    </div>
                                </div>
                            @endforeach
                            <!-- END ITEM -->
