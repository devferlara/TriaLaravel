            ...
            <div class="email-content-wrapper">
              <div class="actions-wrapper menuclipper bg-master-lightest">
                <ul class="actions menuclipper-menu no-margin p-l-20 ">
                  ...
                  <li class="no-padding "><a href="#" class="text-danger" id="eliminar"><i class="fa fa-trash"></i> Borrar</a></li>
                </ul>
    ...
    <div class="tab-content link_mensajeria">
      <div class="tab-pane fade show active" id="firstFull" role="tabpanel" aria-labelledby="first-tab">
        ...
        <div class="scroll">
          ...
          <h5>NAVEGACION</h5>
          <ul>
            <li><a href="{{ url('usuario/mensajes') }}">Recibidos </a><span class="label label-danger label-as-badge pull-right" id="badges" style="color:white;"></span></li>
            <li>
              <a href="{{ url('usuario/mensajes') }}">Todos</a>
              <ul>
                <li>
                  <a href="{{ url('usuario/importantes') }}">Importante</a>
                </li>
                <li>
                  <a href="{{ url('usuario/relevantes') }}">Relevante</a>
                </li>
                <li>
                  <a href="{{ url('usuario/normales') }}">Normal</a>
                </li>
              </ul>
            </li>
            <li><a href="{{ url('usuario/enviados') }}">Enviados</a></li>
          </ul>    
        </div>
      </div>
    </div>
