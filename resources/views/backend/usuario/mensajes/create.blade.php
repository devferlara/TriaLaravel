    ...
    <div class="col-12 chat-app bloques_mensajeria">
      <div class="row">
        ...
        <div class="col-md-12 fondo_blanco_mensajeria" style="padding-top: 40px; padding-bottom:40px">
          {!!Form::open(['route'=>'usuario.mensajes.store','method'=>'POST', 'files'=>'true'])!!}
          <div class="form-inline">
            <div class="col-md-12 form-group">
              {!!Form::label('enviar_a', 'Enviar a:' , ['class'=>'form-label'])!!}
              <select class="form-control select2-multiple" multiple="multiple" name="enviar_a[]" style="width:100%">
                <option value="{{$admin->usuarios->id}}">{{$admin->usuarios->nombres}} {{$admin->usuarios->apellidos}}</option>
              </select>
            </div>
          </div>
          <div class="form-inline">
