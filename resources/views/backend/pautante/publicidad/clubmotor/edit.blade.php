    ...
    <div class="col-md-12">
      <div class="card mb-4">
        <div class="card-body ">
          ...
          <h4 class="text-info text-center">Podrás crear bonos de descuento para los afiliados a nuestro Club Motor para mantener a nuestros usuarios informados y cubran el interés de tu comunidad.</h4>
          <br>
