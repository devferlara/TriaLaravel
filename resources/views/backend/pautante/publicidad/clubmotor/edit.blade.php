                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel panel-body" style="padding:20px;">
                            <div class="row column-seperation">
                                <div class="col-md-12">
                                    {!!Form::model($publivehiculos,['route'=> ['pautante.publicidad.clubmotor.update',$publivehiculos->id],'method'=>'PUT', 'files'=>'true'])!!}
                                    ...
                                    <div class="form-inline">
                                        <div class="col-md-12" style="margin-top:20px;">
                                            ...
                                            <select multiple="multiple" style="width:80%" name="envio[]">                                                <optgroup label="Paises">
                                        ...
                                        <div class="col-md-6 form-group" style="margin-top:20px;">
                                            ...
                                            <div style="float:none;">
                                                ...
                                                {!!link_to_route('pautante.publicidad.clubmotor.index',  $title = 'Cancelar', $parameters = null, $attributes = ['class'=>'btn btn-danger'])!!}
                                            </div>
                                        </div>
