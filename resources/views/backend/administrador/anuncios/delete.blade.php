		...
		<div class="col-md-12">
			<div class="card mb-4">
				<div class="card-body ">
					...
					<h5 class="text-info text-center">Desde el siguiente formulario podras eliminar los anuncios creados desde tu cuenta de administrador, sin embargo recuerda, que este anuncio será borrado permanentemente.!</h5>
					<br>
