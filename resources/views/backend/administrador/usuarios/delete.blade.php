		...
		<div class="col-md-12">
			<div class="card mb-4">
				<div class="card-body">
					...
					<h5 class="text-info">Desde el siguiente formulario podras eliminar los usuarios, sin embargo recuerda, que este proceso solo puede hacer un administrador.!</h5>
