        ...
        <div class="card-body ">
          <div class="panel-heading">
            <div class="col-md-2 pull-right">
              {!!link_to_route('administrador.publicidad.bonos.index', $title = 'Volver a Bonos', $parameters = null, $attributes = ['class'=>'btn btn-primary'])!!}
            </div>
    ...
    <div class="col-lg-12 col-md-12">
      <div class="card mb-4">
        <div class="card-body ">
          <div class="row">
            <div class="col-md-6">
              <h5><i class="iconsmind-Calendar-4" style="font-size:20px;"></i> {{$publicidad->fecha}}</br>Categoria: {{$publicidad->categoria}}</br>Tienda: {{$publicidad->tienda}}</h5>
            </div>
