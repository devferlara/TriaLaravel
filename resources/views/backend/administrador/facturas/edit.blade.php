    ...
    <div class="col-md-12">
      <div class="card mb-4">
        <div class="card-body">
          ...
          <h4 class="text-info" style="text-align: center">Por medio de este módulo podrás editar el archivo de facturación <span style="font-weight:bold">{{$factura->name}}</span></h4>
          <br>
