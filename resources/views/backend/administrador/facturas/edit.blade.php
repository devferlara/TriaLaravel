            ...
            <div class="panel-group col-md-10">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="p-b-5 text-primary" style="text-align:center;"><span class="semi-bold">CarEgar</span> Facturación</h3>
                        </br>
                        <h5 class="text-info">Por medio de este módulo podrás editar el archivo de facturación <span style="font-weight:bold">{{$factura->name}}</span>.</h5>
                    </div>
                    <div class="panel panel-body" style="padding:20px;">
                        {!!Form::open(['route'=>['administrador.facturas.update',$factura->id],'method'=>'PUT', 'files'=>'true'])!!}

                            <div class="form-group" style="margin-top:10px;">
                                <label for="archivo" class="form-label">Nombre de la factura </label>
                               
                                {!!Form::text ('name',$factura->name, ['class'=>'form-control', 'placeholder'=>'Ingrese un nombre para identificar la factura'])!!}
                            </div>
                            ...
                            <div class="form-group">
                                {!!Form::submit('Editar Facturación', ['class'=>'btn btn-primary'])!!}
