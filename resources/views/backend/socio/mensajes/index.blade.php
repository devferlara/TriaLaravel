    ...
    <div class="content full-height">
        ...
        <div class="email-wrapper">
            ...
            <nav class="email-sidebar padding-30">
                ...
                <ul class="main-menu">
                    <li class="active">
                        <a href="{{ url('administrador/mensajes') }}" id="inbox">
                    ...
                    <li>
                        <a href="{{ url('administrador/enviados') }}" id="enviados">
        ...
        <div class="email-opened">
            ...
            <div class="email-content-wrapper">
                <div class="actions-wrapper menuclipper bg-master-lightest">
                    {!!Form::open(['route'=>'administrador.mensajes.destroy','method'=>'DELETE'])!!}
                    <ul class="actions menuclipper-menu no-margin p-l-20 ">
                        <li class="visible-sm-inline-block visible-xs-inline-block">
                            <a href="{{ url('administrador/mensajes') }}" class="email-list-toggle"><i class="fa fa-angle-left"></i> Todos Msg</a>
                        </li>
                        <li class="no-padding "><a href="#" id="btnresponder" class="text-info"><i class="fa fa-reply"></i> Responder</a></li>
                        <li class="no-padding "><a href="{{ url('administrador/mensajes') }}" id="btnleido"><i class="fa fa-thumb-tack"></i> Marcar como leido</a></li>
                        <li class="no-padding "><i class="fa fa-trash" aria-hidden="true"></i> {!!Form::submit('Eliminar Mensaje', ['class'=>'btn btn-danger'])!!}</li>
                        <input type="hidden" id="borrarmsg" name="borrarmsg">
                    </ul>
                ...
                <div class="email-content">
                    ...
                    {!!Form::open(['action'=>'MensajeController@responderMensaje','method'=>'POST', 'files'=>'true'])!!}
                        ...
                        {!!link_to_route('mensajes.index',  $title = 'Cancelar', $parameters = null, $attributes = ['class'=>'btn btn-danger'])!!}
                        </div>  
                        </div>
                    {!!Form::close()!!}  
                    </div>
