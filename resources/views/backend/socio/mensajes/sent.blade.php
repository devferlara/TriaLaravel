...
<div class="page-content-wrapper full-height">
    <div class="content full-height">
            ...
            <nav class="email-sidebar padding-30">
                ...
                <ul class="main-menu">
                    ...
                    <ul class="sub-menu no-padding">
                        <li>
                            <a href="{{url('importantes')}}">
                                <span class="title">Importante</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('relevantes')}}">
        ...
        <div class="email-list b-r b-grey"> <a class="email-refresh" href="enviados"><i class="fa fa-refresh"></i></a>
            <div id="emailList1">
            </div>
        </div>
    <!-- END EMAILS LIST -->
        ...
        <div class="email-opened">
            ...
            <div class="email-content-wrapper">
                <div class="actions-wrapper menuclipper bg-master-lightest">
                    {!!Form::open(['action'=>'MensajeController@destroyEnviados'])!!}
                    <ul class="actions menuclipper-menu no-margin p-l-20 ">
                        <li class="visible-sm-inline-block visible-xs-inline-block">
                            <a href="{{ url('enviados') }}" class="email-list-toggle"><i class="fa fa-angle-left"></i> Todos Msg</a>
                        </li>
                        ...
                        <input type="hidden" id="borrarenviado" name="borrarenviado">
                    </ul>
