...
<div class="page-content-wrapper">
    <div class="content">
        ...
        <div class="container-fluid container-fixed-lg">
            <div class="panel panel-transparent">
                <div class="panel-heading">
                    <div class="panel-title col-md-6">Listado de Conjuntos MS Global</div>
                    <div class="col-md-2 pull-right">
                        {!!link_to_route('administrador.conjuntos.create', $title = '+ Nuevo Conjunto', $parameters = null, $attributes = ['class'=>'btn btn-primary','data-target'=>'#crearconjunto'])!!}
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                    <li>
                                        {!!link_to_route('administrador.conjuntos.edit', $title = 'Editar', $parameters = $conjunto->id, $attributes = ['role'=>'menu-item'])!!}
                                    </li>
                                    <li>
