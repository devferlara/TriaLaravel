        ...
        @include ('errors.request')
            <div class="jumbotron" data-pages="parallax">
                <div class="container-fluid container-fixed-lg">
                    <div class="inner">
                        <h6 class="breadcrumb">Vista Administrador - Bonos de Club Mascotas</h6>
                                ...
                                <div class="col-lg-6 col-md-height col-md-6 col-top">
                                    <div class="panel panel-transparent">
                                        ...
                                        <div class="panel-body">
                                            <h3>Administrador</h3>
                                            <pre class="bg-success" style="color:white; font-weight:bold; font-size:1em;">En esta sección podra estar informado sobre los descuentos o bonos para las mascotas y las necesidades de los residentes de su conjunto.</pre>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading">
                    <div class="panel-title col-md-6">Listado de Bonos de Club Mascotas</div>
            ...
            <table class="table table-hover table-bordered" id="datos">
                ...
                <tbody>
                    ...
                    <td class="v-align-middle">{{$publicidad->valor}}</td>
                    <td>
                    {!!link_to_route('administrador.publicidad.clubmascotas.show', $title = 'Ver', $parameters = $publimascota->id, $attributes = ['class'=>'btn btn-success'])!!}
                @endforeach
                </tbody>
            </table>
