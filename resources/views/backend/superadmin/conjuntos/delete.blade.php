			...
			<div class="panel-group col-md-10">
				<div class="panel panel-info">
					<div class="panel-heading">
                		<h3 class="p-b-5 text-primary" style="text-align:center;"><span class="semi-bold">Eliminar</span> Conjuntos</h3>
                		</br>
                		<p class="text-info">Desde el siguiente formulario podras eliminar los conjuntos, sin embargo recuerda, que este proceso solo puede hacer un administrador.! </p>
            		</div>
