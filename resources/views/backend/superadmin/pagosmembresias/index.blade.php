    ...
    <div class="content">
        ...
        <div class="jumbotron" data-pages="parallax">
            <div class="container-fluid container-fixed-lg">
                <div class="inner">
                    <h6 class="breadcrumb">Super Administrador Pagos de membresias</h6>
                                ...
                                <div class="panel panel-transparent">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <p style="font-weight:bold; font-size:1em;">
                                            En esta sección podra agregar y administrar los pagos de membresias, crearlos y actualizarlos en un instante.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container-fluid container-fixed-lg">
            <div class="panel panel-transparent">
                <div class="panel-heading">
                    <div class="panel-title col-md-6">Listado Pagos de membresias</div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                    <li>
                                        {!!link_to_route('superadmin.pagosmembresias.edit', $title = 'Editar', $parameters = $pago->id, $attributes = ['role'=>'menu-item'])!!}
                                    </li>
                                    <li>
