    ...
    <div class="col-12 chat-app bloques_mensajeria">
      <div class="row">
        ...
        <div class="col-md-12 fondo_blanco_mensajeria" style="padding-top: 40px; padding-bottom:40px">
          {!!Form::open(['route'=>'superadmin.mensajes.store','method'=>'POST', 'files'=>'true'])!!}
          <div class="form-inline">
            <div class="col-md-12 form-group">
              {!!Form::label('enviar_a', 'Enviar a:' , ['class'=>'form-label'])!!}
              <select class="form-control select2-multiple" multiple="multiple" style="width:100%" name="enviar_a[]">
                <optgroup label="Administradores">
                  @foreach($administradores as $admin)
                  <option style="font-family:verdana;"value="{{$admin->id}}">{{$admin->nombres}} {{$admin->apellidos}}</option>
                  @endforeach
                </optgroup>
              </select>
            </div>
