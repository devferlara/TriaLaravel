            ...
            <div class="panel panel-transparent">
                <div class="panel-heading">
                    <div class="col-md-2 pull-right">
                        {!!link_to_route('superadmin.publicidad.clubmotor.index', $title = 'Volver a Bonos Club Motor', $parameters = null, $attributes = ['class'=>'btn btn-primary'])!!}
                    </div>
                        ...
                        <div class="col-md-10 well well-sm" style="background:#10CFBD;">
                            <div class="col-md-4" >
                                <h5><i class="fa fa-calendar" style="font-size:20px;"></i> {{$publivehiculos->fecha}}
                                    ...
                                    </br>Emisor Bono: {{$publivehiculos->emisor}}
                                </h5>
                            </div>
                            <div class="col-md-6" >
