        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body ">
                    ...
                    <h4 class="text-info" style="text-align: center">Podrás crear bonos de descuento para los afiliados a nuestro Club Motor para mantener a nuestros usuarios informados, cubriendo el interés de tu comunidad. </h4>
                    <br>
                    <br>
                    <div class="row form_edit_width">
                        {!!Form::open(['route'=>'superadmin.publicidad.clubmotor.store','method'=>'POST', 'files'=>'true'])!!}
                                ...
                                <div class="form-group has-float-label mb-4">
                                    ...
                                    <select class="full-width form-control" data-init-plugin="select2" id="categoria" name="categoria" style="width: 100%">
                                        <optgroup label="Seleccione una Categoria">
                                            <option value="Lavado">Servicio de Lavado</option>
                                            <option value="Mecanica">Servicios Mecanicos y Talleres</option>
                                            <option value="Accesorios">Accesorios para vehiculos</option>
                                            <option value="Grua">Servicios de Grua</option>
                                            <option value="Seguros">Seguros para vehiculos</option>
                        ...
                        <div class="form-inline">
                            ...
                            <div class="col-md-6" style="margin-top:20px;">
                                <div class="form-group has-float-label mb-4">
                                    ...
                                    {!!Form::date('fecha_hasta','', ['class'=>'form-control', 'placeholder'=>'$', 'style'=>'width:100%'], \Carbon\Carbon::now())!!}
                                </div>
                            </div>
                        </div>
