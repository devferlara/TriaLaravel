            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h3 class="p-b-5 text-primary" style="text-align:center;">
                        ...
                        Anuncio Club Motor- Bono para Vehiculos
                    </h3>
                    <h4 class="text-info">Podrás crear bonos de descuento para los afiliados a nuestro Club Motor para mantener a nuestros usuarios informados y cubran el interés de tu comunidad.</h4>
                    <br>
                    <div class="row form_edit_width">
                        {!!Form::model($publivehiculos,['route'=> ['superadmin.publicidad.clubmotor.update',$publivehiculos->id],'method'=>'PUT', 'files'=>'true'])!!}
                        ...
                        <div class="form-inline">
                            ...
                            <div class="col-md-6" style="margin-top:10px;">
                                <div class="form-group has-float-label mb-4">
                                    {!!Form::label('categoria', 'Categoria-Bono', ['class'=>'form-label'])!!}
                                    {!!Form::select('categoria',['Lavado'=>'Servicio de Lavado', 'Mecanica'=>'Servicios Mecanicos y Talleres', 'Accesorios'=>'Accesorios para vehiculos', 'Grua'=>'Servicios de Grua', 'Seguros'=>'Seguros para vehiculos', 'Conductor-Elegido'=>'Conductor Elegido' ],null, ['style'=>'width:100%', 'class'=>'full-width form-control'])!!}
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 form-group" style="margin-top:20px;">
                            ...
                            <div style="float:none;">
                                ...
                                {!!link_to_route('superadmin.publicidad.clubmotor.index',  $title = 'Cancelar', $parameters = null, $attributes = ['class'=>'btn btn-danger'])!!}
                            </div>
                        </div>
...
<div class="panel-group col-md-10">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="p-b-5 text-primary" style="text-align:center;"><span class="semi-bold">Nuevo</span> Anuncio Club Motor- Bono para Vehiculos</h3>
        </br>
        <h4 class="text-info">Podrás crear bonos de descuento para los afiliados a nuestro Club Motor para mantener a nuestros usuarios informados y cubran el interés de tu comunidad. </h4>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="form-inline">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6 form-group" style="margin-top:10px;">
                            ...
                            {!!Form::select('categoria',[
                                ...
                                'Mecanica'=>'Servicios Mecanicos y Talleres',
                                'Accesorios'=>'Accesorios para vehiculos',
                                'Grua'=>'Servicios de Grua',
                                'Seguros'=>'Seguros para vehiculos',
                    ...
                    <div class="form-inline">
                        <div class="col-md-6 form-group" style="margin-top:20px;">
                            {!!Form::label('fecha_desde', 'Valido-Desde', ['class'=>'form-label'])!!}
                            {!!Form::date('fecha_desde')!!}
                        </div>

                        <div class="col-md-6 form-group" style="margin-top:20px;">
                            {!!Form::label('fecha_hasta', 'Valido-Hasta', ['class'=>'form-label'])!!}
                            {!!Form::date('fecha_hasta')!!}
                        </div>
                    </div>
