        ...
        <div class="col-md-1"></div>
            ...
            <div class="panel-group col-md-10">
                ...
                <div class="panel panel-body" style="padding:20px;">
                   {!!Form::model($zona,['route'=> ['superadmin.zonas.update', $zona->id],'method'=>'PUT'])!!}
...
{{--*/ $conjuntosA[0]="Por favor seleccione una opcion"; 
			foreach($conjuntos as $key=>$con){
		     ...
		     /*--}}
                        ...
                        {!!Form::select('conjunto' ,  $conjuntosA, $zona->conjunto_id,  ['class' => 'form-control'])!!}
                    </div>
                    <div class="form-group">
                    ...
                    {!!link_to_route('superadmin.zonas.index', $title = 'Cancelar', $parameters = null, $attributes = ['class'=>'btn btn-danger'])!!}       
                    </div>
