...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-12">
      <h1 class="breadcrumb">Super Administrador de Noticias y Anuncios</h1>
    </div>
    ...
    <div class="col-md-12">
      <div class="card mb-4">
        <div class="card-body ">
          <div class="row">
            <div class="col-md-4 ">
              <h3>Listado de Noticias o Anuncios</h3>
            </div>
            ...
            <table class="data-table responsive nowrap tabla_bonos_estilos" id="datos">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {!!link_to_route('superadmin.anuncios.show', $title = 'Ver', $parameters = $anuncio->id, $attributes = ['class'=>'btn btn-success btn-xs mb-1'])!!}
                    {!!link_to_route('superadmin.anuncios.edit', $title = 'Editar', $parameters = $anuncio->id, $attributes = ['class'=>'btn btn-secondary btn-xs mb-1'])!!} 
                    {!!link_to_action('AnunciosController@deletesuper', $title = 'Borrar', $parameters =$anuncio->id, $attributes = ['class'=>'btn btn-danger btn-xs mb-1'])!!}
                  </td>
                </tr>
                @endforeach
              </tbody>
