			...
			<div class="panel-group col-md-10">
				<div class="panel panel-info">
            		...
            		<div class="panel panel-body" style="padding:20px;">
						{!!Form::model($apartamento,['route'=> ['superadmin.apartamentos.destroy',$apartamento->id],'method'=>'DELETE'])!!}
							<div class="">
					...
					{!!link_to_route('superadmin.apartamentos.index', $title = 'Cancelar', $parameters = null, $attributes = ['class'=>'btn btn-primary'])!!}
					{!!Form::close()!!}
				</div>
			</div>
		</div>
