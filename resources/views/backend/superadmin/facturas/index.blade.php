        ...
        @include ('errors.request')
            ...
            <div class="panel panel-transparent">
                <div class="panel-heading">
                    <div class="panel-title col-md-6">Listado Recibos de Pago Administraciones por conjunto</div>
                ...
                <div class="pull-left" style="80%">
                    ...
                    {!!Form::open(['action'=>'FacturaController@buscar','method'=>'POST' , 'class'=>'navbar-form', 'role'=>'search'])!!}
                    <div class="form-group">
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                <li>
                                    {!!link_to_route('superadmin.recibosdepago.edit', $title = 'Editar Recibo', $parameters = $recibo->id , $attributes = ['role'=>'menu-item'])!!}
                                </li>
                            </ul>
                        </div>
                    </td>
